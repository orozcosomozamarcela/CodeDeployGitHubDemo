import csv # este sería el programa principal
...
def imprimir_notas_alumnos(alumnos, notas):
    ...
    next(notas_csv) # aca saltea los encabezados porque no los usamos ni necesitamos para este ejemplo sino tendriamos que ponerlos en una variable.
    next(alumnos_csv)
...
imprimir_notas_alumnos("alumnos.csv", "notas.csv") # aca se pasan los dos archivos relacionados
