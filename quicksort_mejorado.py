...
def _quick_sort ( lista , inicio , fin ):
    ...
    Mensaje: la lista está ordenada. """
    if  inicio  >=  fin :
        return
...
def  _swap ( lista , i , j ):
    print ( f" { lista } , posicion: { i } valor { lista [ i ] } , posicion lista: { j } valor menores { lista [ j ] } " )

    """Intercambia los elementos iyj de lista."""
